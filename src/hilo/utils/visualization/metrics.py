...
def visualize_metrics_data(prep_batch, batch_idx=0, class_names=None):
    ...
    fig.add_trace(go.Scatter(x=[None], y=[None], mode='lines', line=dict(color='green'), name='Ground Truth'))
    fig.add_trace(go.Scatter(x=[None], y=[None], mode='lines', line=dict(color='blue'), name='Prediction'))
